...
############################################################
# Integration Tests - Image Federated Cycle for REGRESSION #
############################################################

def test_integration_image_regress_cycle(driver, image_cycle_payloads):

    project_payload = image_cycle_payloads['project']
    project_create_resp = driver.projects.create(**project_payload)
    assert project_create_resp['status'] in [200, 201]

    expt_payloads = image_cycle_payloads['experiment']
    ...
    registration_payloads = image_cycle_payloads['registration']
    ...
    validate_payloads = image_cycle_payloads['validation']
    ...
    predict_payloads = image_cycle_payloads['prediction']
